...
def generate_gcode(substrate_width, substrate_height, track_length, track_spacing, num_tracks):
    Testing_Mode = 0
    camera = 0

    os.chdir(os.path.dirname(os.path.abspath(__file__)))

    df_opt = pd.read_csv('tst.csv')
...
def generate_and_download_code(n_clicks, substrate_width, substrate_height, track_length, num_tracks, track_spacing):
    if n_clicks > 0:
        full_gcode = generate_gcode(substrate_width, substrate_height, track_length, track_spacing, num_tracks)
